...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/c/build/XtraTrax-Audio-Only/prefix --target-os=mingw32 --arch=x86_64 --cc=x86_64-w64-mingw32-clang --cxx=x86_64-w64-mingw32-clang++ --ar=llvm-ar --ranlib=llvm-ranlib --nm=llvm-nm --strip=llvm-strip --enable-shared --disable-static --disable-autodetect --disable-gpl --disable-nonfree --disable-version3 --disable-network --disable-programs --disable-doc --disable-debug --disable-x86asm --disable-everything --enable-protocol=file --enable-demuxer='wav,flac,mp3,mov,ogg,aac' --enable-parser='aac,aac_latm,flac,mpegaudio,opus,vorbis' --enable-decoder='aac,aac_fixed,aac_latm,alac,flac,mp3,mp3float,mp3adu,mp3adufloat,mp3on4,mp3on4float,opus,vorbis,pcm_s8,pcm_u8,pcm_s16le,pcm_s16be,pcm_s24le,pcm_s24be,pcm_s32le,pcm_s32be,pcm_f32le,pcm_f32be,pcm_f64le,pcm_f64be' --enable-filter='abuffer,abuffersink,aresample,aformat,volume,alimiter,loudnorm,anull'
prefix=/c/build/XtraTrax-Audio-Only/prefix
...
CC_IDENT=clang version 22.1.8 (https://github.com/llvm/llvm-project.git ca7933e47d3a3451d81e72ac174dcb5aa28b59d1)
ARCH=x86
INTRINSICS=sse2
EXTERN_PREFIX=
CC=x86_64-w64-mingw32-clang
CXX=x86_64-w64-mingw32-clang++
AS=x86_64-w64-mingw32-clang
OBJCC=x86_64-w64-mingw32-clang
LD=x86_64-w64-mingw32-clang
DEPCC=x86_64-w64-mingw32-clang
DEPCCFLAGS= $(CPPFLAGS)
DEPCXX=x86_64-w64-mingw32-clang
DEPCXXFLAGS= $(CPPFLAGS)
DEPAS=x86_64-w64-mingw32-clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC11_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DWIN32_LEAN_AND_MEAN -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC -I$(SRC_PATH)/compat/stdbit
CFLAGS=   -std=c17 -U__STRICT_ANSI__ -fomit-frame-pointer -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wmissing-prototypes -Wstrict-prototypes -Wunterminated-string-initialization -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Wno-implicit-const-int-float-conversion -Wno-microsoft-enum-forward-reference -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=   -D__STDC_CONSTANT_MACROS -std=c++17 -fomit-frame-pointer -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Wno-implicit-const-int-float-conversion -Wno-microsoft-enum-forward-reference -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
OBJCFLAGS=   -fomit-frame-pointer -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Wno-implicit-const-int-float-conversion -Wno-microsoft-enum-forward-reference -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS=  -Wl,--nxcompat,--dynamicbase -Wl,--high-entropy-va -Wl,--as-needed -Qunused-arguments
...
X86ASM_DEPFLAGS=
GLSLC_DEPFLAGS=
HOSTCC=x86_64-w64-mingw32-clang
HOSTLD=x86_64-w64-mingw32-clang
...
HOSTLDFLAGS=
HOSTEXTRALIBS=-lm
DEPHOSTCC=x86_64-w64-mingw32-clang
