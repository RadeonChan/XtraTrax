...
__attribute__((used,noinline)) static void loadExtraSetting(void) {
 ...
 else strcat(settingsPath,"\\NFSU2-NativeTrax-MagiPack.ini");
...
BOOL WINAPI DllMain(HINSTANCE module,DWORD reason,LPVOID reserved) {
 ...
 DWORD tempLen=GetTempPathA(MAX_PATH,logpath);if(tempLen&&tempLen+sizeof("NativeTrax-MagiPack.log")<=MAX_PATH)strcat(logpath,"NativeTrax-MagiPack.log");else strcpy(logpath,"NativeTrax-MagiPack.log");
